...
| **Stock Analysis** | Finance | Distinct from CrewAI synthesis or trading simulation: emits reusable JSON Evidence Packs with source/date provenance and explicit missing data, plus investor-ready reports | [![GitHub](https://img.shields.io/badge/Code-GitHub-black?logo=github)](https://github.com/AdvancingTitans/stock-analysis) |
