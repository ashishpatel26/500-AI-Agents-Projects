...
| **OpenCodeReview** | Software Development | AI agent for line-level PR review combining deterministic rules with an LLM | [![GitHub](https://img.shields.io/badge/Code-GitHub-black?logo=github)](https://github.com/alibaba/open-code-review) |
