...
| **[Orkas](https://orkas.ai?source=gh-500agents)** | Software Development | Local-first desktop workspace where a Commander decomposes goals and coordinates specialist AI agents in parallel or sequence | [![GitHub](https://img.shields.io/badge/Code-GitHub-black?logo=github)](https://github.com/Orkas-AI/Orkas) |
