...
| **Loopy** | Software Development | Kanban-based agent operating system that orchestrates 43 coding-agent CLIs with complexity-aware routing, named subagents, and verifiable execution receipts. Core loop runs fully locally; optional integrations via API keys. | [![GitHub](https://img.shields.io/badge/Code-GitHub-black?logo=github)](https://github.com/arjunkshah/loopy) |
